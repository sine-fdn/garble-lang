use garble::{
    ast::Type, check, compile, eval::Evaluator, literal::Literal, token::UnsignedNumType, Error,
};
...
";
    let checked = check(prg).map_err(|e| pretty_print(e, prg))?;
...
#[test]
fn compile_short_circuiting_and() -> Result<(), Error> {
    let prg = "
fn main(b: bool) -> bool {
    b & [true; 0][1]
}
...
#[test]
fn compile_short_circuiting_or() -> Result<(), Error> {
    let prg = "
fn main(b: bool) -> bool {
    b | [true; 0][1]
}
